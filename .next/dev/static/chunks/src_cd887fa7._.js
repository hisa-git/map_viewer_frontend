...
"[project]/src/components/constants/temperaturecolors.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/three/WeatherRenderer.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.core.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/constants/temperaturecolors.js [app-client] (ecmascript)");
;
;
class WeatherRenderer {
    ...
    _createTile(lat, lon, temperature, humidity) {
        const [x, z] = this.toLocal(lon, lat);
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaneGeometry"](this.tileSize, this.tileSize);
        let color;
        if (this.mode === "temperature" && typeof temperature === "number") {
            color = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tempToColor"])(temperature, this.minTemp, this.maxTemp);
        } else if (this.mode === "humidity" && typeof humidity === "number") {
            color = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["humidityToColor"])(humidity, this.minHumidity, this.maxHumidity);
        } else {
            color = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](0xff00ff); // ярко-малиновый для пропущенных данных
        }
        if (this.debug) {
            console.log("Tile", {
                lat,
    ...
    updateMode(meshGroup, newMode) {
        ...
        meshGroup.traverse((obj)=>{
            ...
            if (newMode === "temperature" && typeof temperature === "number") {
                ...
                color = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](0xff00ff);
            }
...
class WeatherChunkLoader {
    constructor(scene, opts = {}){
        ...
        const projectionHelpers = {
            toLocal: (lon, lat)=>{
                const proj4 = __turbopack_context__.r("[project]/node_modules/proj4/lib/index.js [app-client] (ecmascript)");
                const WGS84 = "EPSG:4326";
                const WEB_MERCATOR = "EPSG:3857";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/components/three/WeatherRenderer.js [app-client] (ecmascript) <locals>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ThreeScene({ settings = {} }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeScene.useEffect": ()=>{
            ...
            const weatherLoader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createWeatherLoader"])(scene, {
...
//# sourceMappingURL=src_cd887fa7._.js.map