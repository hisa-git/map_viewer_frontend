...
class WeatherRenderer {
    ...
    _getTileSize(lat, step) {
        const [x1, z1] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$modules$2f$projection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lonLatToWebMercator"])(0, lat);
        const [x2, z2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$modules$2f$projection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lonLatToWebMercator"])(step, lat);
        const [x3, z3] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$modules$2f$projection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lonLatToWebMercator"])(0, lat + step);
        return {
            sizeX: Math.abs(x2 - x1),
            sizeZ: Math.abs(z3 - z1)
        };
...
"[project]/Projects/MAN_MVP/frontend/src/components/three/hooks/useThreeRenderer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useThreeRenderer(containerRef) {
    _s();
    const [renderer, setRenderer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useThreeRenderer.useEffect": ()=>{
            if (!containerRef.current) return;
            const r = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["WebGLRenderer"]({
                antialias: true
            });
...
_s(useThreeRenderer, "gbUehPdZMn281QEGK+ysA6GG5W0=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$three$2f$hooks$2f$useThreeRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/MAN_MVP/frontend/src/components/three/hooks/useThreeRenderer.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ThreeScene({ settings = {} }) {
    ...
    const renderer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$three$2f$hooks$2f$useThreeRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThreeRenderer"])(containerRef);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeScene.useEffect": ()=>{
            ...
            const dirLight = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DirectionalLight"](0xffffff, 1.2);
            dirLight.position.set(1000, 2000, 1000);
            const ambLight = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AmbientLight"](0xffffff, 0.35);
            scene.add(ambLight);
                            ...
                            group.traverse({
                                "ThreeScene.useEffect.loop": (obj)=>{
                                    ...
                                    if ([
                                        ...
                                        "trunk",
                                        "primary"
                                    ].includes(t)) k = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].clamp(2000 / dist, 0.4, 2.5);
                                    else if ([
                                        "footway",
                                        "path",
                                        "service"
                                    ].includes(t)) k = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].clamp(900 / dist, 0.2, 1.0);
                                    else k = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].clamp(1200 / dist, 0.3, 1.3);
...
_s(ThreeScene, "pxLCkFqc5Un38tA4ELelMv2uWaU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$three$2f$hooks$2f$useThreeRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThreeRenderer"]
    ];
});
_c = ThreeScene;
var _c;
...
_s(MapInterface, "2+ORJtIcUUHW9Ri13Dh24wPzlNc=");
_c1 = MapInterface;
var _c, _c1;
...
//# sourceMappingURL=Projects_MAN_MVP_frontend_src_ba392281._.js.map