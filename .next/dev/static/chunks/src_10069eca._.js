...
"[project]/src/components/three/LayerRenderer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/three/FeatureRenderers.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/LayerRenderer.js [app-client] (ecmascript)");
;
;
;
class BuildingsRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature(feature) {
...
class RoadsRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature(feature) {
        const geom = feature.geometry;
...
class RiversRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature(feature) {
        const geom = feature.geometry;
        const props = feature.properties || {};
        const meshes = [];
    ...
    _waterPolygonToMesh(polygonCoords) {
        ...
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShapeGeometry"](shape);
...
class HeatmapRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature() {
        return [];
    }
}
...
"[project]/src/components/three/RenderersMap.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/FeatureRenderers.js [app-client] (ecmascript)");
;
const RENDERERS = {
    buildings: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BuildingsRenderer"],
    roads: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RoadsRenderer"],
    rivers: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RiversRenderer"],
    heatmap: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HeatmapRenderer"]
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$RenderersMap$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/RenderersMap.js [app-client] (ecmascript)");
;
;
;
class ChunkLoader {
    constructor(scene, opts = {}){
        ...
        for (const layer of this.layers){
            const Renderer = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$RenderersMap$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RENDERERS"][layer];
            if (Renderer) {
    ...
    _renderMultiLayer(combinedData, key) {
        ...
        for (const [layerName, data] of Object.entries(combinedData.layers)){
            ...
            for (const { material, geometries: geomsForMat } of materials.values()){
                ...
                try {
                    const mergedGeometry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$utils$2f$BufferGeometryUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeGeometries"])(geomsForMat, false);
                    const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](mergedGeometry, material);
                    mesh.castShadow = true;
                    mesh.receiveShadow = true;
                    ...
                    geomsForMat.forEach((geom)=>{
                        const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](geom, material.clone());
                        mesh.castShadow = true;
                        mesh.receiveShadow = true;
                        mesh.userData.layer = layerName;
                        group.add(mesh);
...
//# sourceMappingURL=src_10069eca._.js.map