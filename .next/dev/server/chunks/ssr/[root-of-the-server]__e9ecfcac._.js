...
"[project]/src/components/constants/temperaturecolors.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/three/WeatherRenderer.js [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.core.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/constants/temperaturecolors.js [app-ssr] (ecmascript)");
;
;
class WeatherRenderer {
    constructor(centerOffset = [
        ...
        this.tileSize = opts.tileSize ?? 500; // увеличено для видимости
        this.tileHeight = opts.tileHeight ?? 5;
        this.elevationAboveGround = opts.elevationAboveGround ?? 20; // поднято для дебага
        this.mode = opts.mode ?? "temperature";
        this.opacity = opts.opacity ?? 1; // полностью непрозрачные
        this.debug = opts.debug ?? true; // вывод в консоль
    }
    setMode(mode) {
        if (mode !== "temperature" && mode !== "humidity") {
            console.warn(`Invalid mode: ${mode}. Use 'temperature' or 'humidity'`);
            return;
        }
        this.mode = mode;
    }
    renderWeatherData(data) {
        ...
        for (const point of data.points){
            const { lat, lon, temperature, humidity } = point;
            if (typeof lat !== "number" || typeof lon !== "number") {
                console.warn("WeatherRenderer: invalid lat/lon", point);
                continue;
            }
            const mesh = this._createTile(lat, lon, temperature, humidity);
            if (mesh) meshes.push(mesh);
        }
        return meshes;
    }
    _createTile(lat, lon, temperature, humidity) {
        const [x, z] = this.toLocal(lon, lat);
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlaneGeometry"](this.tileSize, this.tileSize);
        let color;
        if (this.mode === "temperature" && typeof temperature === "number") {
            color = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tempToColor"])(temperature, this.minTemp, this.maxTemp);
        } else if (this.mode === "humidity" && typeof humidity === "number") {
            color = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humidityToColor"])(humidity, this.minHumidity, this.maxHumidity);
        } else {
            color = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xff00ff); // ярко-малиновый для пропущенных данных
        }
        if (this.debug) {
            console.log("Tile", {
                lat,
    ...
    updateMode(meshGroup, newMode) {
        ...
        meshGroup.traverse((obj)=>{
            ...
            let color;
            if (newMode === "temperature" && typeof temperature === "number") {
                color = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tempToColor"])(temperature, this.minTemp, this.maxTemp);
            } else if (newMode === "humidity" && typeof humidity === "number") {
                color = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$temperaturecolors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["humidityToColor"])(humidity, this.minHumidity, this.maxHumidity);
            } else {
                color = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xff00ff);
            }
            if (obj.material) obj.material.color.copy(color);
            obj.userData.mode = newMode;
        });
    }
}
class WeatherChunkLoader {
    constructor(scene, opts = {}){
        ...
        const projectionHelpers = {
            toLocal: (lon, lat)=>{
                const proj4 = __turbopack_context__.r("[project]/node_modules/proj4/lib/index.js [app-ssr] (ecmascript)");
                const WGS84 = "EPSG:4326";
                const WEB_MERCATOR = "EPSG:3857";
                const [x0, z0] = proj4(WGS84, WEB_MERCATOR, [
                    lon,
                    lat
                ]);
                return [
        ...
        this.weatherRenderer = new WeatherRenderer(this.centerOffset, projectionHelpers, opts);
    }
    _chunkKey(minLon, minLat, maxLon, maxLat) {
        return `${minLon.toFixed(6)}_${minLat.toFixed(6)}_${maxLon.toFixed(6)}_${maxLat.toFixed(6)}`;
    }
    async loadChunk(minLon, minLat, maxLon, maxLat, opts = {}) {
        const { signal = null, useCache = true, keyHint = null } = opts;
        const key = keyHint || this._chunkKey(minLon, minLat, maxLon, maxLat);
        if (useCache && this.loaded.has(key)) return this.loaded.get(key);
        this.loaded.set(key, null);
        ...
        try {
            ...
            if (!r.ok) {
                ...
                throw new Error(`server ${r.status}: ${errText}`);
            }
            const data = await r.json();
            this.loaded.set(key, data);
            const rendered = this._renderData(data, key);
            ...
            this.loaded.delete(key);
            if (e.name !== "AbortError") console.error("WeatherChunkLoader error:", e);
            return null;
        }
    }
    _renderData(data, key) {
        ...
        let rendered = 0;
        if (data.points) {
            const meshes = this.weatherRenderer.renderWeatherData(data) || [];
            for (const m of meshes){
                if (!m) continue;
                group.add(m);
                rendered++;
        ...
        if (rendered > 0) {
            this.scene.add(group);
            this.meshGroups.set(key, group);
            console.log(`Added ${rendered} weather tiles to scene (key: ${key})`);
        } else {
            console.warn(`No weather tiles rendered for chunk ${key}`);
        }
        return rendered;
    }
    removeChunk(key) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/components/three/WeatherRenderer.js [app-ssr] (ecmascript) <locals>");
"use client";
;
;
;
...
function ThreeScene({ settings = {} }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const weatherLoader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createWeatherLoader"])(scene, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e9ecfcac._.js.map