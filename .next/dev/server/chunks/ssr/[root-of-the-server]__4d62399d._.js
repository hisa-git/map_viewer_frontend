...
class LayerRenderer {
    ...
    setCenterFromLonLat(lon, lat) {
        const [x, z] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proj4$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])("EPSG:4326", "EPSG:3857", [
            lon,
            lat
        ]);
        this.centerOffset = [
...
class BuildingsRenderer extends PolygonRendererBase {
    renderFeature({ geometry, properties = {} }) {
        ...
        const build = (coords)=>{
            ...
            if (!shape) return;
            const g = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ExtrudeGeometry"](shape, {
                depth: height,
                bevelEnabled: false
            });
            g.rotateX(-Math.PI / 2);
            ...
            const m = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](g, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
                color: 0xcccccc,
                roughness: 0.8,
                metalness: 0.2
            }));
...
class RiversRenderer extends PolygonRendererBase {
    renderFeature({ geometry }) {
        ...
        const build = (coords)=>{
            const shape = this._coordsToShape(coords);
            if (!shape) return;
            const g = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ShapeGeometry"](shape);
            g.rotateX(-Math.PI / 2);
            g.computeBoundingBox();
            g.computeBoundingSphere();
            const m = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](g, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
...
class RoadsRenderer extends LayerRenderer {
    ...
    _lineToMesh(coords, props) {
        ...
        g.setAttribute("position", new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Float32BufferAttribute"](positions, 3));
        g.setIndex(indices);
...
class ChunkLoader {
    constructor(scene, opts = {}){
        ...
        const Renderer = opts.customRenderer ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$GeometryRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RENDERERS"][this.layerType];
    ...
    async loadChunk(minLon, minLat, maxLon, maxLat) {
        ...
        const [ox, oz] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proj4$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])("EPSG:4326", "EPSG:3857", [
            cx,
            cy
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d62399d._.js.map