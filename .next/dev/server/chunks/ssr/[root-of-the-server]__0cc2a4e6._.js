...
"[project]/src/components/three/GeometryRenderers.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$defaults$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/constants/defaults.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.core.js [app-ssr] (ecmascript)");
;
;
function _lineToMesh(coords = [], props = {}) {
    if (!Array.isArray(coords) || coords.length < 2) return null;
    const y = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$defaults$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULTS"].roadY;
    ...
    for(let i = 0; i < pts.length - 1; i++){
        ...
        const dir = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vector3"]().subVectors(p2, p1);
...
function coordsToShape(polygonCoords = []) {
    ...
    for(let i = 1; i < polygonCoords.length; i++){
        ...
        shape.holes.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Path"](pts));
    }
    return shape;
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$defaults$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/constants/defaults.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$GeometryRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/GeometryRenderers.js [app-ssr] (ecmascript)");
;
;
;
;
...
/* ---------- Base Renderer ---------- */ class LayerRenderer {
    ...
    toLocal(lon, lat) {
        const [x0, z0] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proj4$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(this._projFrom, this._projTo, [
            lon,
            lat
        ]);
        return [
...
/* ---------- Polygon Base ---------- */ class PolygonRendererBase extends LayerRenderer {
    _ensureClosed(ring = []) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$GeometryRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureClosed"].call(this, ring);
    }
    _coordsToShape(polygonCoords = []) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$GeometryRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["coordsToShape"].call(this, polygonCoords);
    }
}
/* ---------- Buildings ---------- */ class BuildingsRenderer extends PolygonRendererBase {
    renderFeature(feature) {
        ...
        if (!geometry) return [];
        const height = properties.height ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$defaults$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULTS"].buildingHeight;
        const meshes = [];
        const handleCoords = (coords)=>{
            ...
            const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](extrude, mat);
...
class RoadsRenderer extends LayerRenderer {
    renderFeature(feature) {
        ...
        const handleLine = (coords)=>{
            const mesh = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$GeometryRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["_lineToMesh"].call(this, coords, properties);
    ...
    _getRoadWidth(props = {}) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$defaults$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULTS"].roadWidths[t] ?? 5;
    }
    _getRoadColor(props = {}) {
        const t = props.fclass || props.highway || props.type || "residential";
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$constants$2f$defaults$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULTS"].roadColors[t] ?? 0xdddddd;
    }
}
...
function createProjectionHelpers(centerOffset) {
    return {
        toLocal: (lon, lat)=>{
            const [x0, z0] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proj4$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(WGS84, WEB_MERCATOR, [
                lon,
                lat
            ]);
            return [
...
"[project]/src/components/three/WeatherRenderer.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/* ---------- Temperature color mapping ---------- */ function tempToColor(temp, minTemp = -30, maxTemp = 45) {
    ...
    if (t < 0.2) {
        color.lerpColors(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x0000ff), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x00ffff), t / 0.2);
    } else if (t < 0.4) {
        color.lerpColors(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x00ffff), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x00ff00), (t - 0.2) / 0.2);
    } else if (t < 0.6) {
        color.lerpColors(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x00ff00), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xffff00), (t - 0.4) / 0.2);
    } else if (t < 0.8) {
        color.lerpColors(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xffff00), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xff8800), (t - 0.6) / 0.2);
    } else {
        color.lerpColors(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xff8800), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xff0000), (t - 0.8) / 0.2);
    }
    return color.getHex();
}
class WeatherRenderer {
   ...
   */ renderWeatherData(data) {
    ...
    _createBar(lat, lon, temperature) {
        ...
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CylinderGeometry"](this.barRadius, this.barRadius, height, this.barSegments);
        const color = tempToColor(temperature, this.minTemp, this.maxTemp);
        const material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            color: color,
            roughness: 0.7,
            metalness: 0.3,
            emissive: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x000000)
        });
        const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](geometry, material);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/WeatherRenderer.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ThreeScene({ settings = {} }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const [centerX, centerZ] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proj4$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])("EPSG:4326", "EPSG:3857", [
            startLon,
            startLat
        ]);
        ...
        scene.add(dirLight);
        scene.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AmbientLight"](0x666666, 0.8));
        ...
        controls.update();
        // --- Helpers ---
        const projectionHelpers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoader$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProjectionHelpers"])([
            centerX,
            centerZ
        ]);
        // --- Loaders ---
        ...
        // --- Weather Loader ---
        const weatherRenderer = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WeatherRenderer"]([
            centerX,
            centerZ
        ], projectionHelpers, {
            minTemp: -20,
        ...
        const weatherLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoader$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0cc2a4e6._.js.map