...
"[project]/src/components/three/ChunkLoaderBACKUP.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ChunkLoader {
    constructor(centerLon, centerLat){
        ...
        this.renderers = {
            buildings: new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BuildingsRenderer"]([
                centerLon,
                centerLat
            ]),
            roads: new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RoadsRenderer"]([
                centerLon,
                centerLat
            ]),
            water: new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RiversRenderer"]([
                centerLon,
                centerLat
            ]),
            rivers: new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RiversRenderer"]([
                centerLon,
                centerLat
            ]),
            heatmap: new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HeatmapRenderer"]([
                centerLon,
                centerLat
            ])
        };
    ...
    async loadChunk(layer, chunkId) {
        const key = `${layer}:${chunkId}`;
        if (this.cache.has(key)) return this.cache.get(key);
        const url = `/chunk/${layer}/${chunkId}.json`;
        let json;
        try {
            ...
            console.error("[ChunkLoader] Fetch error:", err);
            return [];
        }
        const meshes = this._renderFeatures(layer, json);
        this.cache.set(key, meshes);
        return meshes;
    }
    _renderFeatures(layer, json) {
        const renderer = this.renderers[layer];
        if (!renderer) return [];
        if (!json || !json.features || !Array.isArray(json.features)) return [];
        const result = [];
        for (const feature of json.features){
            const rendered = renderer.renderFeature(feature);
            if (rendered && rendered.length) {
                for (const m of rendered)result.push(m);
            }
        }
        return result;
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.core.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proj4$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/proj4/lib/index.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoaderBACKUP$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/ChunkLoaderBACKUP.js [app-ssr] (ecmascript)");
...
function ThreeScene({ settings }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const waterLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoaderBACKUP$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
        ...
        const buildingsLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoaderBACKUP$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
        ...
        const roadsLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoaderBACKUP$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__36e0bb6b._.js.map