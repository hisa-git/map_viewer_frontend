...
function ThreeScene({ settings = {} }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        scene.background = settings.nightMode ? new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x0a0a2a) : new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0xbfd9ff);
        ...
        const dirLight = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DirectionalLight"](0xffffff, settings.nightMode ? 0.6 : 1.2);
        dirLight.position.set(1000, 2000, 1000);
        scene.add(dirLight);
        const ambLight = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AmbientLight"](0xffffff, settings.nightMode ? 0.15 : 0.35);
        scene.add(ambLight);
        ...
        controls.update();
        const getLoader = (layerKey, scene, url)=>{
            if (!url) return null;
            return new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$three$2f$ChunkLoader$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
                url,
                centerOffset: [
                    centerX,
                    centerZ
                ...
                onProgress: (meta)=>{
                    setStatus((s)=>({
                            ...s,
                            [layerKey]: meta.rendered || 0
                        }));
                }
            });
        };
        const buildingsLoader = settings.buildings ? getLoader("buildings", scene, `${envBase}/chunk/buildings`) : null;
        const roadsLoader = settings.traffic ? getLoader("roads", scene, `${envBase}/chunk/roads`) : null;
        const waterLoader = settings.terrain ? getLoader("water", scene, `${envBase}/chunk/water`) : null;
        const weatherLoader = settings.weather ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createWeatherLoader"])(scene, {
        ...
        if (buildingsLoader) loadersRef.current.set("buildings", buildingsLoader);
        if (roadsLoader) loadersRef.current.set("roads", roadsLoader);
        if (waterLoader) loadersRef.current.set("water", waterLoader);
        if (weatherLoader) loadersRef.current.set("weather", weatherLoader);
        ...
        const groundMat = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            color: settings.terrain ? 0xf0f0f0 : 0x808080,
            roughness: 1,
            metalness: 0
        });
        ...
        const loop = ()=>{
            ...
            controls.update();
            if (roadsLoader?.meshGroups) {
                for (const group of roadsLoader.meshGroups.values()){
                    group.visible = settings.traffic;
                }
            }
            if (buildingsLoader?.meshGroups) {
                for (const group of buildingsLoader.meshGroups.values()){
                    group.visible = settings.buildings;
                }
            }
            if (weatherLoader?.meshGroups) {
                for (const group of weatherLoader.meshGroups.values()){
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b8a0bb1._.js.map