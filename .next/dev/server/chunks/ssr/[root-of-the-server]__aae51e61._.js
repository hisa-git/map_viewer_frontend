...
"[project]/src/components/three/LayerRenderer.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class LayerRenderer {
    constructor(centerOffset = [
        ...
        this.centerOffset = centerOffset; // смещение для текущего чанка
        this.wgs84 = "EPSG:4326";
        this.webMercator = "EPSG:3857";
    }
    // Преобразование координат из WGS84 в локальные XYZ относительно centerOffset
    toLocal(lon, lat) {
        const [x0, z0] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proj4$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(this.wgs84, this.webMercator, [
            lon,
            lat
        ]);
...
"[project]/src/components/three/FeatureRenderers.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/LayerRenderer.js [app-ssr] (ecmascript)");
;
;
;
class BuildingsRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature(feature) {
    ...
    _polygonToMesh(polygonCoords, height) {
        ...
        for(let h = 1; h < polygonCoords.length; h++){
            ...
            const pts = holeRing.map(([lon, lat])=>{
                const [x, z] = this.toLocal(lon, lat);
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vector2"](x, z);
            });
            const path = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Path"](pts);
            shape.holes.push(path);
        }
        // Уменьшаем высоту экструзии, если она слишком большая
        const clampedHeight = Math.min(height, 500);
        const extrude = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ExtrudeGeometry"](shape, {
            depth: clampedHeight,
            bevelEnabled: false
        });
        // ВАЖНО: не мержим геометрию с rotateX, а создаём отдельный меш с правильной ориентацией
        extrude.rotateX(-Math.PI / 2);
        extrude.computeVertexNormals();
        const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](extrude, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            color: 0xcccccc,
            roughness: 0.8,
            metalness: 0.2
        }));
...
class RoadsRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature(feature) {
        const geom = feature.geometry;
    ...
    _lineToMesh(coords, props) {
        ...
        for(let i = 0; i < pts.length - 1; i++){
            const p1 = pts[i];
            const p2 = pts[i + 1];
            const dir = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vector3"]().subVectors(p2, p1).normalize();
            const perp = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Vector3"](-dir.z, 0, dir.x).multiplyScalar(width / 2);
...
class RiversRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature(feature) {
        const geom = feature.geometry;
        const props = feature.properties || {};
        const meshes = [];
        if (geom.type === "Polygon") {
            const m = this._waterPolygonToMesh(geom.coordinates);
            if (m) meshes.push(m);
        } else if (geom.type === "MultiPolygon") {
            for (const poly of geom.coordinates){
                const m = this._waterPolygonToMesh(poly);
                if (m) meshes.push(m);
            }
        } else if (geom.type === "LineString") {
            const m = this._waterLineToMesh(geom.coordinates, props);
            if (m) meshes.push(m);
        } else if (geom.type === "MultiLineString") {
            for (const ls of geom.coordinates){
                const m = this._waterLineToMesh(ls, props);
                if (m) meshes.push(m);
            }
        }
        return meshes;
    }
    _waterPolygonToMesh(polygonCoords) {
        if (!Array.isArray(polygonCoords) || polygonCoords.length < 1) return null;
        ...
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ShapeGeometry"](shape);
    ...
    _waterLineToMesh(coords, props) {
        ...
        const width = this._getWaterWidth(props);
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BufferGeometry"]();
        const positions = [];
        const indices = [];
        const uvs = [];
    ...
    _getWaterWidth(props) {
        const type = props.fclass || props.waterway || props.type || "unknown";
        const widths = {
            river: 25,
            stream: 8,
            canal: 12,
        ...
        return widths[type] || 15;
    }
}
class HeatmapRenderer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$LayerRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LayerRenderer"] {
    renderFeature() {
        return [];
    }
}
}),
"[project]/src/components/three/RenderersMap.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/FeatureRenderers.js [app-ssr] (ecmascript)");
;
const RENDERERS = {
    buildings: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BuildingsRenderer"],
    roads: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RoadsRenderer"],
    rivers: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RiversRenderer"],
    heatmap: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$FeatureRenderers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HeatmapRenderer"]
};
}),
"[project]/src/components/three/ChunkLoader.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$RenderersMap$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/RenderersMap.js [app-ssr] (ecmascript)");
;
;
;
class ChunkLoader {
    constructor(scene, opts = {}){
        ...
        // Теперь поддерживаем несколько слоёв одновременно
        this.layers = opts.layers || [
            "buildings",
            "roads",
            "water"
        ];
        this.MAX_CHUNKS = opts.maxChunks || 50;
        // Создаём рендереры для каждого слоя
        this.renderers = {};
        for (const layer of this.layers){
            const Renderer = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$RenderersMap$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RENDERERS"][layer];
            if (Renderer) {
                this.renderers[layer] = new Renderer(this.centerOffset);
            }
        }
    }
    _chunkKey(a, b, c, d) {
    ...
    async loadChunk(minLon, minLat, maxLon, maxLat, opts = {}) {
        const { simplify = 1, signal = null, useCache = true, keyHint = null, limit = 2000 } = opts;
        ...
        // Загружаем все слои параллельно
        const fetchPromises = this.layers.map((layer)=>this._fetchLayer(layer, minx, miny, maxx, maxy, simplify, limit, signal));
        const allPromise = Promise.all(fetchPromises).then((layerDataArray)=>{
            const combinedData = {
                layers: {},
                totalFeatures: 0
            };
            layerDataArray.forEach((data, idx)=>{
                const layer = this.layers[idx];
                if (data && data.features) {
                    combinedData.layers[layer] = data;
                    combinedData.totalFeatures += data.features.length;
                }
            });
            if (useCache) this.loaded.set(key, combinedData);
            const rendered = this._renderMultiLayer(combinedData, key);
            this.onProgress({
                key,
                featuresTotal: combinedData.totalFeatures,
                rendered,
            ...
            if (useCache) this.loaded.delete(key);
            if (e.name !== "AbortError") console.error("ChunkLoader fetch error:", e);
            return null;
        }).finally(()=>{
            this.inFlight.delete(key);
        });
        if (useCache) this.inFlight.set(key, allPromise);
        return allPromise;
    }
    async _fetchLayer(layer, minx, miny, maxx, maxy, simplify, limit, signal) {
        ...
        try {
            ...
            if (!r.ok) throw new Error(`${layer}: server ${r.status}`);
            return await r.json();
        } catch (e) {
            if (e.name !== "AbortError") {
                console.warn(`Failed to fetch ${layer}:`, e.message);
            }
            return null;
        }
    }
    _renderMultiLayer(combinedData, key) {
        if (!combinedData || !combinedData.layers) return 0;
        ...
        let totalRendered = 0;
        // Рендерим каждый слой отдельно, затем объединяем
        for (const [layerName, data] of Object.entries(combinedData.layers)){
            if (!data || !data.features) continue;
            const renderer = this.renderers[layerName];
            if (!renderer) continue;
            const geometries = [];
            const materials = new Map();
            for (const feature of data.features){
                if (!feature.geometry) continue;
                const meshes = renderer.renderFeature(feature);
                if (!meshes) continue;
                for (const m of meshes){
                    if (!m || !m.geometry) continue;
                    // Группируем геометрии по материалам для оптимизации
                    const matKey = this._getMaterialKey(m.material);
                    ...
                    materials.get(matKey).geometries.push(m.geometry);
                    totalRendered++;
                }
            }
            // Создаём меши для каждого типа материала
            for (const { material, geometries: geomsForMat } of materials.values()){
                if (geomsForMat.length === 0) continue;
                try {
                    const mergedGeometry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$utils$2f$BufferGeometryUtils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mergeGeometries"])(geomsForMat, false);
                    const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](mergedGeometry, material);
                    mesh.castShadow = true;
                    mesh.receiveShadow = true;
                    mesh.userData.layer = layerName;
                    group.add(mesh);
                } catch (e) {
                    console.warn(`Failed to merge geometries for ${layerName}:`, e);
                    // Если мердж не удался, добавляем по отдельности
                    geomsForMat.forEach((geom)=>{
                        const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](geom, material.clone());
                        mesh.castShadow = true;
                        mesh.receiveShadow = true;
                        mesh.userData.layer = layerName;
                        group.add(mesh);
        ...
        if (group.children.length > 0) {
            ...
            // Ограничиваем количество чанков в сцене
            if (this.meshGroups.size > this.MAX_CHUNKS) {
                const oldestKey = this.meshGroups.keys().next().value;
                this.removeChunk(oldestKey);
            }
        }
        return totalRendered;
    }
    _getMaterialKey(material) {
        return `${material.color?.getHex() || 0}_${material.roughness}_${material.metalness}_${material.transparent ? 1 : 0}`;
    }
    removeChunk(key) {
...
function createCamera(width, height) {
    const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerspectiveCamera"](75, width / height, 0.1, 1000000);
...
function ThreeScene({ settings }) {
    ...
    const [cameraObj, setCameraObj] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loaders, setLoaders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const waterLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoader$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
        ...
        const buildingsLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoader$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
        ...
        const roadsLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ChunkLoader$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChunkLoader"](scene, {
        ...
        async function updateChunks() {
            ...
            try {
                ...
                // ...
                tilesToLoad.map((tile)=>Promise.all([
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aae51e61._.js.map