...
"[project]/Projects/MAN_MVP/frontend/src/components/three/WeatherRenderer.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/MAN_MVP/frontend/node_modules/three/build/three.core.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$examples$2f$jsm$2f$renderers$2f$CSS2DRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/MAN_MVP/frontend/node_modules/three/examples/jsm/renderers/CSS2DRenderer.js [app-ssr] (ecmascript)");
...
class WeatherRenderer {
    constructor(projectionHelpers, opts = {}){
        ...
        if (!this.tileSizeX || !this.tileSizeZ) {
            throw new Error("tileSizeX / tileSizeZ are required");
        }
    ...
    renderWeatherData(data) {
        ...
        for (const point of data.points){
            const g = this._createTile(point);
            if (g) groups.push(g);
        }
        return groups;
    }
    _createTile({ lat, lon, temperature, humidity }) {
        ...
        if (this.mode === "temperature" && typeof temperature === "number") {
            ...
            color = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Color"](0x444444);
        }
        // --- плоскость ---
        ...
        const tile = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Mesh"](geometry, material);
        tile.rotation.x = -Math.PI / 2;
        tile.position.set(x + this.tileSizeX / 2, this.elevationAboveGround, z + this.tileSizeZ / 2);
        // --- текст ---
        const label = this._createLabel(temperature, humidity);
        label.position.set(0, 6, 0); // локально над тайлом
        // --- группа ---
        const group = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Group"]();
        group.add(tile);
        group.add(label);
    ...
    _createLabel(temperature, humidity) {
        const text = this.mode === "temperature" ? `${temperature?.toFixed(1)}°C` : `${humidity?.toFixed(1)}%`;
        ...
        const label = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$examples$2f$jsm$2f$renderers$2f$CSS2DRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CSS2DObject"](div);
    ...
    updateMode(group, newMode) {
        ...
        group.traverse((obj)=>{
            ...
            const { temperature, humidity, tile, label } = obj.userData;
            let color;
            ...
            if (label) {
                label.element.textContent = newMode === "temperature" ? `${temperature?.toFixed(1)}°C` : `${humidity?.toFixed(1)}%`;
            }
        });
    }
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/MAN_MVP/frontend/src/components/three/WeatherRenderer.js [app-ssr] (ecmascript)");
...
function ThreeScene({ settings = {} }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const ambLight = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AmbientLight"](0xffffff, 0.35);
        scene.add(ambLight);
        ...
        const weatherLoader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$MAN_MVP$2f$frontend$2f$src$2f$components$2f$three$2f$WeatherRenderer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createWeatherLoader"])(scene, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95c312c5._.js.map