...
/**
 * Рекурсивно устанавливает visible для объекта и всех его детей
 */
...
/**
 * Применяет visibility ко всем группам в Map
 */
...
/**
 * Очищает неиспользуемые чанки из лоадера
 */
 ...
 */
export function createGround(size, color, yOffset) {
...
/**
 * Обновляет видимость и масштаб дорог в зависимости от расстояния до камеры
 */
...
/**
 * Генерирует список тайлов для загрузки
 */
